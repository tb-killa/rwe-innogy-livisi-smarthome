...
public class SIPcosFirmwareUpdateCommandHandlerExt : SIPcosFirmwareUpdateCommandHandler
{
	public SIPcosFirmwareUpdateCommandHandlerExt(SIPcosHandler handler)
		: base(handler)
	{
	}
