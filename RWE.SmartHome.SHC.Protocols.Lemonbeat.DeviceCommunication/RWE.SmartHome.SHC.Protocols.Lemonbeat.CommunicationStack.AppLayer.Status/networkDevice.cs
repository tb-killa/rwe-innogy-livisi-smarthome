...
public class networkDevice
{
	...
	[XmlElement("status_report", typeof(statusReportType))]
	[XmlElement("status_get_level", typeof(statusGetLevelType))]
	[XmlElement("status_report_level", typeof(statusReportLevelType))]
	[XmlElement("status_set_level", typeof(statusSetLevelType))]
	public object[] Items
	{
		get
		{
