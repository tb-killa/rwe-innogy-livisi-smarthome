...
{
	private static readonly Type IReadonlyGenericType = typeof(ReadOnlyCollection<>);
	...
	public static IList CreateContainer(Type listType, Type listItemType, out bool isReadOnly)
	{
		...
		if ((object)listType.GetConstructor(BindingFlags.Instance | BindingFlags.Public, null, new Type[0], null) != null)
		{
			return (IList)Activator.CreateInstance(listType);
		}
		if (IReadonlyGenericType.IsAssignableFrom(listType.GetGenericTypeDefinition()))
		{
			isReadOnly = true;
