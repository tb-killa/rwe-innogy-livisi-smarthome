...
[XmlRoot(ElementName = "SetManagedSHCConfiguration", Namespace = "http://rwe.com/SmartHome/2010/11/08/PublicFacingServices")]
[GeneratedCode("System.ServiceModel", "3.0.0.0")]
[DebuggerStepThrough]
public class SetManagedSHCConfigurationRequest
{
	...
	public SetManagedSHCConfigurationRequest()
	{
	}

	public SetManagedSHCConfigurationRequest(string shcSerialNo, string configDataVersion, ConfigurationType configType, string xPath, string bulkXMLData, int currentPacketNumber, int nextPacketNumber, string correlationID, bool createRestorePointFirst)
	{
