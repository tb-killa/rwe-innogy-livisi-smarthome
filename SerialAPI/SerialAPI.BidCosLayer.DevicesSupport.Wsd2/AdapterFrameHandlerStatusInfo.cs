...
internal class AdapterFrameHandlerStatusInfo : AdapterFrameHandler<Wsd2Adapter>
{
	public AdapterFrameHandlerStatusInfo(Wsd2Adapter deviceAdapter)
		: base(deviceAdapter)
	{
	}
	...
	public override SendStatus Handle(BidCosMessageForSend message)
	{
		...
		{
			if (base.DeviceAdapter.wsdComm.ConfigStatus(base.DeviceAdapter.Address, message.message[1], message.mode))
			{
