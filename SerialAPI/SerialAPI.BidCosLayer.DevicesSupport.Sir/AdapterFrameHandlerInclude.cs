...
internal class AdapterFrameHandlerInclude : AdapterFrameHandler<SirAdapter>
{
	public AdapterFrameHandlerInclude(SirAdapter deviceAdapter)
		: base(deviceAdapter)
	{
	}
	...
	public override SendStatus Handle(BidCosMessageForSend message)
	{
		...
		if (message.message[1] == 8)
		{
			...
			sendStatus = base.DeviceAdapter.TryInclusionForSir();
